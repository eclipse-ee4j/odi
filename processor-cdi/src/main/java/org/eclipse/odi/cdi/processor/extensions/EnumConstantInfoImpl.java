...
final class EnumConstantInfoImpl extends DeclarationInfoImpl implements FieldInfo {
    private final EnumConstantElement fieldElement;
    private final VisitorContext visitorContext;
    private final ClassInfoImpl declaringInfo;

    EnumConstantInfoImpl(ClassInfoImpl declaringInfo, EnumConstantElement element, Types types, VisitorContext visitorContext) {
    ...
    public EnumConstantElement getElement() {
        return fieldElement;
    }
    ...
    public boolean equals(Object o) {
        ...
        EnumConstantInfoImpl other = (EnumConstantInfoImpl) o;
