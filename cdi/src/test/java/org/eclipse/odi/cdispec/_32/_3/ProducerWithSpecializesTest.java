...
package org.eclipse.odi.cdispec._32._3;
...
@OdiTest
public class ProducerWithSpecializesTest {
    @Test
    ...
    void testProducerMethod(PaymentProcessor paymentProcessor, List<Product> products) {
        assertTrue(paymentProcessor instanceof MockPaymentProcessor);
        assertEquals(1, products.size());
        assertEquals("Mocked", products.iterator().next().name);
    }
}
